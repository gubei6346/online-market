<template>
  <div class="login">
    <div class="container">
      <a href="/#/index"><img src="../assets/image/home.png" alt=""></a>
    </div>
    <div class="wrapper">
      <div class="container">
    ...
    <div class="footer">
      <div class="footer-link">
        <a href="" target="_blank">家具商城</a><span>|</span>
        <a href="" target="_blank">家具商城</a><span>|</span>
        <a href="" target="_blank">家具商城</a><span>|</span>
        <a href="" target="_blank">家具商城</a>
      </div>
      <p class="copyright"> 家具商城 </p>
    </div>
  </div>
</template>
<script>
...
.login{
  ...
  .wrapper{
    background:url('../assets/image/07.jpg') no-repeat center;
    .container{
      height:576px;
      .login-form{
